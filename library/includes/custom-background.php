...
add_action( 'after_setup_theme', 'fst_custom_background_setup', 15 );

# Filter the background color late.
add_filter( 'theme_mod_background_color', 'fst_background_color', 95 );
 ...
 * @return void
 */
function fst_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'fst_custom_background_callback',
		)
	);
}
 ...
 * @return string
 */
function fst_background_color( $color ) {
 ...
 * @return void
 */
function fst_custom_background_callback() {
